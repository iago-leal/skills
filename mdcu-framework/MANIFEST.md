...
├── rsop/SKILL.md              (1.4.0 — checklist de qualidade do SOAP com 10 itens binários, cap F-4 declarado, auto-aplicado em F6.c)
...
| 9 | Checklist de qualidade do SOAP — 10 itens binários verificáveis, cap F-4 declarado (necessário ≠ suficiente); auto-aplicado em F6.c do MDCU; não-bloqueante | `rsop` | 1.3.0 → **1.4.0** |
